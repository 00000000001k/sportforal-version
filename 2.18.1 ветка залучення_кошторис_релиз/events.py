...
def add_event(event_name, tabview, restore=False):
    ...
    # === Контейнер для договорів ===contracts_frame = ctk.CTkScrollableFrame(tab, label_text=f"Договори заходу: {event_name}")
