...
def add_event(event_name, tabview, restore=False, event_number=None):
    ...
    # ИЗМЕНЕНИЕ: Передаем event_number в create_common_fields_block
    common_frame, common_entries = create_common_fields_block(tab, event_name, tabview, event_number)
    ...
    def add_contract_to_this_event():
        ...
        # ИЗМЕНЕНИЕ: Передаем event_number в create_document_fields_block
        create_document_fields_block(contracts_frame, tabview, template_path, event_number)
